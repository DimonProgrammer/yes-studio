...
/* ──────────────────────────────────────────────
   ...
   ────────────────────────────────────────────── */
const faqItems = [
  { q: 'В чём заключается работа стрим-моделью?', a: 'Работа заключается в общении с иностранными пользователями сайтов. В основном это люди, которые чувствуют себя одинокими и хотят быть услышанными. У пользователей могут быть самые разные просьбы, но модель вправе выполнять только те, которые не нарушают её личные границы.' },
  { q: 'У меня нет опыта, есть ли обучение?', a: 'Не переживай. Наша команда обучит тебя всем секретам работы, поможет освоиться и начать зарабатывать с первого дня работы. Каждой модели предоставляется бесплатное годовое онлайн-обучение в самой известной школе стримеров. По истечении 3 месяцев вы выйдете на доход 130 000 ₽, 6 месяцев — 180 000 ₽, 9 месяцев — 360 000 ₽ и более.' },
  { q: 'Сколько я буду зарабатывать?', a: 'Заработная плата от 90 000 руб. в месяц. Наша команда сделает всё, чтобы ваш результат превзошёл ожидания.' },
  { q: 'Нужно ли знать английский язык?', a: 'Не обязательно — для упрощения работы на всех компьютерах стоят автоматические переводчики.' },
  { q: 'Модельная внешность обязательна?', a: 'Вовсе нет. Гораздо важнее ваши коммуникабельность, харизма и умение выстраивать долгосрочные отношения.' },
  { q: 'Получится ли совмещать с основной работой?', a: 'Конечно! Но если вы захотите достичь супервысокого результата, нужна максимальная вовлечённость и большее количество часов работы.' },
  { q: 'Как происходят выплаты?', a: 'По стандарту выплаты раз в неделю, но мы можем рассмотреть условия, при которых выплаты будут каждый день.' },
  { q: 'Я не хочу, чтобы меня увидели жители моей страны?', a: 'До начала работы мы обговариваем все нюансы, включая и этот. Мы легко можем заблокировать возможность просмотра для любых стран, включая страны СНГ. Россию часто блокируем целиком, хотя у нас работают девушки, которым это не принципиально.' },
  { q: 'Что с отпусками?', a: 'Отпуск 30 календарных дней в год. Дополнительный отпуск возможен — согласовывается с администратором индивидуально.' },
  { q: 'Нужно ли за что-то платить?', a: 'Нет, студия предоставляет всё абсолютно бесплатно.' },
  { q: 'Стриминг — это законно и безопасно?', a: 'Мы предоставим все необходимые рекомендации для сохранения анонимности и конфиденциальности наших сотрудников. Это абсолютно законно — в нашей студии категорически запрещено раздеваться!' },
  { q: 'Я могу доверять вам свои личные данные?', a: 'Вся информация, которую вы предоставляете нам, является полностью конфиденциальной. Мы хотим, чтобы все модели чувствовали себя в полной безопасности, поэтому мы никогда не раскрываем их личность.' },
];
          ...
          <div className="container">
            ...
            <div className="bento">
              <div className="bento-card tilt-card reveal reveal-delay-1">
                ...
                <div className="bento-visual bento-visual--strategy"></div>
              ...
              <div className="bento-card tilt-card reveal reveal-delay-2">
                ...
                <div className="bento-visual bento-visual--image"></div>
                <div className="bento-body">
              ...
              <div className="bento-card tilt-card reveal reveal-delay-3">
                ...
                <div className="bento-visual bento-visual--content"></div>
                <div className="bento-body">
              ...
              <div className="bento-card tilt-card reveal reveal-delay-1">
                ...
                <div className="bento-visual bento-visual--career"></div>
                <div className="bento-body">
              ...
              <div className="bento-card tilt-card reveal reveal-delay-2">
                ...
                <div className="bento-visual bento-visual--support"></div>
                <div className="bento-body">
              ...
              <div className="bento-card tilt-card reveal reveal-delay-3">
                ...
                <div className="bento-visual bento-visual--languages"><span className="bento-sparkle"></span></div>
                <div className="bento-body">
