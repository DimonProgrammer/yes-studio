...
export const pages = {
  ...
  home: {
    ...
    description:
      'Вебкам студия Yes Studio. Non-nude формат, доход от 90 000₽, ' +
  ...
  moscow: {
    path: '/msk',
    title: 'Вебкам студия в Москве — Yes Studio | Работа моделью от 90 000₽',
    description:
      'Вебкам студия Yes Studio в Москве. Non-nude формат, доход от 90 000₽/мес, ' +
  ...
  rostov: {
    ...
    description:
      'Yes Studio в Ростове-на-Дону. Non-nude вебкам студия с доходом от 90 000₽. ' +
...
export const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'В первый месяц — от 90 000 ₽ при стандартном графике 5 смен по 7 часов. Через 3–6 месяцев опытные модели выходят на 150 000–300 000 ₽. Топ-модели зарабатывают от 300 000 ₽.',
      },
    },
    {
      '@type': 'Question',
